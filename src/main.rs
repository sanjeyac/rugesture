...
#[derive(PartialEq)]
#[derive(Debug)]
enum GestureDirection { NONE, UP, DOWN, LEFT, RIGHT }

fn parse_direction_from(line: &String) -> GestureDirection {
...
fn extract_speeds(string: String)  -> Result<(f32, f32), ParseFloatError> {
...
fn direction_of( speeds : (f32, f32) ) -> GestureDirection {
...
fn sanitarize(line: &String) -> String {
...
fn compute(line: String, last_update: &mut String) {        
...
fn run_debug_input() -> Result<(), Error> {
